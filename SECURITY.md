...
If you believe you have found a security vulnerability in `z4j-taskiq`,
...
This adapter runs inside TaskIQ workers with their broker access. An
authenticated brain can submit registered tasks through the advertised
control. Task-name/argument validation, result-backend probing, and middleware
event mapping are package-specific security surfaces; transport, redaction,
and authorization policy remain owned by `z4j-core` and the brain.
